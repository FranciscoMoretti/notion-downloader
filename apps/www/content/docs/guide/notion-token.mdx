...
Once you have your Notion API token, you can use it in two ways:

1. Add it to a `.env` file:

   ```bash
   NOTION_TOKEN=your_token_here
   ```

2. Use it directly with the CLI:

   ```bash
   npx notion-downloader --notion-token your_token_here
   ```
